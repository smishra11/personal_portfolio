  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <div className="fixed right-4 bottom-4 z-30 sm:right-6 sm:bottom-6">
        <ChatButton isOpen={false} onClick={() => setIsOpen(true)} />
      </div>
    </Dialog>
  );
}
